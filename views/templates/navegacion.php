<nav class="navegador">
    <ul>
        <li>
            <a href="<?php if( $_SESSION['rol'] === '1' ){?> /admin <?php } else { ?>/asesor <?php }?>">
        ...
        <?php if($_SESSION['rol'] === '1'){?>
            <li>
                <a href="/usuarios">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-person-rolodex" viewBox="0 0 16 16">
