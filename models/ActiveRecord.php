...
class ActiveRecord {
    ...
    public static function order($orden) {
    ...
    //Buscar un atributo en especifico
    ...
    //Consultar la base de datos (Cuando los modelos no son suficientes)
    ...
    //Categorizar
    public static function categorizar($limite1){
        $query = "SELECT * FROM producto p  INNER JOIN categoria c ON p.categoriaId = c.id WHERE c.categoria = '".$limite1."' ORDER BY precio";
